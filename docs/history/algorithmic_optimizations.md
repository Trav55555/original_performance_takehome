...
> Historical January 2026 proposals, retained without revalidating their predictions. "Current", "not yet applied" and lower-bound claims refer to the old graph and knowledge at that time. See the [full history](../performance-progression.md) and [technique wiki](../reference/README.md) for later tests and current conclusions.
